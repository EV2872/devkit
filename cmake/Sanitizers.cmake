...
function(devkit_enable_sanitizers target_name)
    ...
    if(NOT ENABLE_THREAD_SANITIZER)
        ...
        target_compile_options(${target_name} PUBLIC -fsanitize=${SANITIZER_LIST} -fno-omit-frame-pointer)
        target_link_options(${target_name} PUBLIC -fsanitize=${SANITIZER_LIST})
    else()
